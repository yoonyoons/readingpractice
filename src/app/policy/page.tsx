    ...
    <main className="mx-auto min-h-dvh w-full max-w-2xl bg-white px-5 pb-16 pt-6 md:my-8 md:min-h-0 md:max-w-3xl md:rounded-3xl md:px-10 md:shadow-sm">
      ...
      <Section title="2. 어떤 정보를 저장하나요?">
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>결과 분석표: 학습 기록으로 만든 AI 의견(학생용 격려 문장, 선생님용 지도 메모)</li>
        </ul>
      ...
      <Section title="3. AI는 어떻게 쓰이나요?">
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            결과 분석표의 AI 의견은 퀴즈 정답률·요약 점수·틀린 낱말 같은 학습 기록 수치로 만들어요. 이때도 학생의 이름과
            번호는 보내지 않아요. 학생용 문장은 학생 화면에 보이고, 선생님이 고칠 수 있어요.
          </li>
